...
#define TYPE_RISCV_CPU_NEXELL_SWALLOW32 RISCV_CPU_TYPE_NAME("nexell-swallow32")
#define TYPE_RISCV_CPU_NEXELL_SWALLOW64 RISCV_CPU_TYPE_NAME("nexell-swallow64")
